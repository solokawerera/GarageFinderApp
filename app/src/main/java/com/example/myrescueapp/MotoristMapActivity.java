...
public class MotoristMapActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private Context mContext = MotoristMapActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MotoristMapActivity.this,new  String[]{Manifest.permission.ACCESS_FINE_LOCATION},LOCATION_REQUEST_CODE);
            return;
        }
        else {
...
//        mapFragment.getMapAsync(this);
        ...
        SettingsButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(MotoristMapActivity.this, SettingsActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(-0.424, 36.9483))
                .title("Nyeri Car garage"));

        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(-0.421,36.9526))
                .title("Nyeri Central Garage")
                .snippet("best for repair services"));

        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(-0.4108,36.9534))
                .title("Autospine Garage"));

        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(-0.4033,36.9692))
                .title("Kuct Garage"));
        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(-0.4216,36.9554))
                .title("Grogon Area Garage"));

        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(-0.4195,36.9514))
                .title("Chemas Auto Garage"));

        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(-0.424,36.9573))
                .title("SmartLeaf Packing solution"));
                ...
                new android.app.AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(MotoristMapActivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
                            }
                        })
                        .create()
                        .show();
...
//    }
    ...
    {
        Intent startPageIntent = new Intent(MotoristMapActivity.this, WelcomeActivity.class);
